...
<html>
	<head>
		...
		<script type="text/javascript" src="./javascript/MarkerGrid.js"></script>
		<script type="text/javascript" src="./javascript/MarkerTile.js"></script>
		<script type="text/javascript" src="./javascript/bounds.js"></script>
		<script type="text/javascript" src="./javascript/pegel.js"></script>
		<script type="text/javascript">
			...
			function drawmap() {
				...
				{ attribution:"Alle Pegeldaten stammen von www.pegelonline.wsv.de", projection: new OpenLayers.Projection("EPSG:4326"), visibility: false, displayOutsideMaxExtent:true});
				//layer_harbours.setOpacity(0.8);
				layer_tidal_scale.setOpacity(0.8);
				
//
				//selber
				layer_tidal = new OpenLayers.Layer.Text( "Pegel-Statisch",
                    		{ location:"./textfile.txt",
				attribution:"Alle Pegeldaten stammen von www.pegelonline.wsv.de", projection: new OpenLayers.Projection("EPSG:4326"), visibility: true, displayOutsideMaxExtent:true});
				layer_tidal.setOpacity(0.8);


				POI = new OpenLayers.Layer.MarkerGrid( "Pegel-Dynamisch",
				{
				type:'txt',
				getURL: get_poi_url,
				attribution:"Alle Pegeldaten stammen von www.pegelonline.wsv.de", 
				buffer: 0
				});
...
//				
				...
				map.addLayers([layer_mapnik, layer_tah, layer_seamark, layer_harbours, layer_download, layer_sport, layer_tidal, POI]);
